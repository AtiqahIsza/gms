<div style="background-color: white;">
    ...
    <div wire:model="branchCode">
        <div class="float-container">
            ...
            <button class="btn btn-smrs my-3" style=" width:130px; display:inline-block;" href="">Pairing Meter</button>
            <button class="btn btn-smrs my-3" style=" width:200px; display:inline-block;" href="">Non-Pairing Meter</button>
        </div>
        ...
        <button class="btn btn-danger my-3 //!$bulkSelected ? 'disabled' : '' ">Reject Selected</button>-->
            ...
            <table class="table table-striped table-responsive" id="table">
                ...
                <tr>
                    ...
                    <th>Actual/Consumption CF of the Month <br> {{now()->format('M')}} </th>
